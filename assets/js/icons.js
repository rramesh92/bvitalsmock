/* Inline SVG icons (self-authored, Feather-style). No external icon font/CDN. */
window.Icon = (function () {
  ...
  return {
    logo: '<svg class="logo" viewBox="0 0 24 24" fill="none"><path d="M3 12h3l2-5 3 10 3-7 2 4h5" stroke="#19a7ab" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
    ...
    award: s('<circle cx="12" cy="8" r="6"/><path d="M8.2 13.9 7 22l5-3 5 3-1.2-8.1"/>'),
    ...
    timeline: s('<line x1="3" y1="12" x2="21" y2="12"/><circle cx="7" cy="12" r="2"/><circle cx="17" cy="12" r="2"/><line x1="12" y1="3" x2="12" y2="7"/><line x1="12" y1="17" x2="12" y2="21"/>')
  };
})();
